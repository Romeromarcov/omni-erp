...
import { Alert, Box, Button, Card, IconButton, MenuItem, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField } from '@mui/material';
...
const NotaCreditoVentaFormPage: React.FC = () => {
  ...
  return (
    <PageContainer maxWidth={900}>
      <PageHeader
        title={`${isEditing ? 'Editar' : 'Crear'} Nota de Crédito de Venta`}
        actions={
          <Button variant="outlined" color="secondary" onClick={() => navigate('/ventas/notas-credito-venta')}>
            Cancelar
          </Button>
        }
      />
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <Card sx={{ p: { xs: 2, md: 3 }, mb: 3 }}>
          ...
          {fields.length > 0 && (
            <Box sx={{ mt: 3, p: 2, bgcolor: 'grey.100', borderRadius: 1, textAlign: 'right', fontWeight: 700 }}>

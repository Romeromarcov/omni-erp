"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``control_asistencia``.
...
_TABLES = [
    ("control_asistencia_horariotrabajo", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("control_asistencia", "0004_alter_asignacionhorario_id_asignacion_horario_and_more"),
    ]

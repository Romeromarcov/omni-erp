"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``costos``.
...
_TABLES = [
    ("costos_analisis_variacion_costo", "id_empresa_id", False),
    ("costos_costo_estandar_producto", "id_empresa_id", False),
    ("costos_costo_produccion", "id_empresa_id", False),
]

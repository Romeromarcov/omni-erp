"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``gastos``.
...
_TABLES = [
    ("gastos_categoriagasto", "id_empresa_id", False),
    ("gastos_gasto", "id_empresa_id", False),
    ("gastos_reembolsogasto", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("gastos", "0002_alter_categoriagasto_id_categoria_gasto_and_more"),
    ]

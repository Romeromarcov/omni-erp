"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``integracion_b2b``.
...
_TABLES = [
    ("integracion_b2b_configuracionintegracion", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("integracion_b2b", "0002_alter_configuracionintegracion_id_configuracion_and_more"),
    ]

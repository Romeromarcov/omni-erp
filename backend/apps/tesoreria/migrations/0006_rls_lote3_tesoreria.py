"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``tesoreria``.
...
_TABLES = [
    ("tesoreria_conciliacion_bancaria", "id_empresa_id", False),
    ("tesoreria_movimiento_bancario", "id_empresa_id", False),
    ("tesoreria_operacion_cambio_divisa", "empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("tesoreria", "0005_rename_tesoreria_mov_empresa_estado_idx_tesoreria_m_id_empr_5161fd_idx_and_more"),
    ]

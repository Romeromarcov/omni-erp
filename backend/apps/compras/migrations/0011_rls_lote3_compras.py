"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``compras``.
...
_TABLES = [
    ("compras_factura_compra", "id_empresa_id", False),
    ("compras_requisicion_compra", "id_empresa_id", False),
    ("compras_solicitud_cotizacion", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("compras", "0010_rls_lote2_compras"),
    ]

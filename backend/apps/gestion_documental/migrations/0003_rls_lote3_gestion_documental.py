"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``gestion_documental``.
...
_TABLES = [
    ("gestion_documental_carpeta", "id_empresa_id", False),
    ("gestion_documental_documento", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("gestion_documental", "0002_alter_carpeta_id_carpeta_and_more"),
    ]

"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``agentes``.
...
_TABLES = [
    ("agentes_config_agente", "id_empresa_id", False),
    ("agentes_prediccionagente", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("agentes", "0003_rename_agentes_pre_id_empr_idx_agentes_pre_id_empr_dcf018_idx_and_more"),
    ]

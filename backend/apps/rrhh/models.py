...
class BeneficioEmpleado(models.Model):
    ...
    estado = models.CharField(
        max_length=20,
        choices=[("ACTIVO", "Activo"), ("SUSPENDIDO", "Suspendido"), ("TERMINADO", "Terminado")],
        default="ACTIVO",
    )
...
class LicenciaEmpleado(models.Model):
    ...
    id_aprobador = models.ForeignKey(
        "Empleado", on_delete=models.SET_NULL, null=True, blank=True, related_name="licencias_aprobadas"
    )

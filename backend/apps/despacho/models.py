...
class Despacho(models.Model):
    ...
    id_pedido = models.ForeignKey(
        "ventas.Pedido", on_delete=models.CASCADE, related_name="despachos", null=True, blank=True
    )
    id_orden_compra = models.ForeignKey(
        "compras.OrdenCompra", on_delete=models.CASCADE, related_name="despachos", null=True, blank=True
    )
    fecha_despacho = models.DateTimeField()
    id_almacen_origen = models.ForeignKey(
        "almacenes.Almacen", on_delete=models.CASCADE, related_name="despachos_origen"
    )
    direccion_destino = models.TextField()
    id_transportista = models.ForeignKey(
        "rrhh.Empleado", on_delete=models.SET_NULL, null=True, blank=True, related_name="despachos_transportista"
    )
...
class DetalleDespacho(models.Model):
    ...
    id_unidad_medida = models.ForeignKey(
        "inventario.UnidadMedida", on_delete=models.CASCADE, related_name="detalles_despacho"
    )

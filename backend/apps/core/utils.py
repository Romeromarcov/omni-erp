    ...
    if dispositivo.tiene_caja_fisica:
        ...
        if sesion_activa:
            ...
            return {
                ...
                "datos": {"caja_fisica": dispositivo.caja_fisica, "sesion": sesion_activa},
            }
        else:
            ...
            return {
                ...
                "datos": {"caja_fisica": dispositivo.caja_fisica, "dispositivo": dispositivo},
            }

    # Si no tiene caja y no se debe preguntar, no hacer nada
    if not dispositivo.preguntar_crear_caja:
        return {"accion": "nada", "mensaje": "Dispositivo registrado sin caja física asociada", "datos": {}}

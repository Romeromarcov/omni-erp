"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``contabilidad``.
...
_TABLES = [
    ("contabilidad_asiento_contable", "id_empresa_id", False),
    ("contabilidad_mapeo_contable", "id_empresa_id", False),
    ("contabilidad_plan_cuentas", "id_empresa_id", False),
]

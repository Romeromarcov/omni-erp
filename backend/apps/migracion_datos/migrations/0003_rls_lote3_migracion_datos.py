"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``migracion_datos``.
...
_TABLES = [
    ("migracion_datos_procesomigracion", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("migracion_datos", "0002_alter_detalleerrormigracion_id_detalle_error_and_more"),
    ]

"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``nomina``.
...
_TABLES = [
    ("nomina_concepto_nomina", "id_empresa_id", False),
    ("nomina_periodo_nomina", "id_empresa_id", False),
    ("nomina_proceso_nomina", "id_empresa_id", False),
    ("nomina_proceso_nomina_extrasalarial", "id_empresa_id", False),
]

"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``personalizacion``.
...
_TABLES = [
    ("personalizacion_entidad_instancia", "id_empresa_id", False),
    ("personalizacion_estado_personalizado", "id_empresa_id", False),
    ("personalizacion_personalizacionconfig", "id_empresa_id", False),
    ("personalizacion_vista_personalizada", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("personalizacion", "0003_rename_idx_ent_inst_emp_nombre_personaliza_id_empr_3b51c3_idx_and_more"),
    ]

"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``saas``.
...
_TABLES = [
    ("saas_suscripcion", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("saas", "0002_rename_saas_sus_empresa_estado_idx_saas_suscri_id_empr_47df32_idx_and_more"),
    ]

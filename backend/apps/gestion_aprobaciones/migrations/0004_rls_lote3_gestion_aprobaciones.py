"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``gestion_aprobaciones``.
...
_TABLES = [
    ("gestion_aprobaciones_tipo_aprobacion", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("gestion_aprobaciones", "0003_alter_flujoaprobacion_id_flujo_aprobacion_and_more"),
    ]

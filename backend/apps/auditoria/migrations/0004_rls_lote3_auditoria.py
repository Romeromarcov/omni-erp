"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``auditoria``.
...
_TABLES = [
    ("auditoria_logauditoria", "id_empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("auditoria", "0003_alter_logauditoria_id_log_auditoria"),
    ]

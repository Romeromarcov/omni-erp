...
from apps.ventas.models import DetalleNotaVenta, DetallePedido, NotaVenta, Pedido
...
def empresa():
    return Empresa.objects.create(
        nombre_legal="Empresa Test", nombre_comercial="TestCom", identificador_fiscal="J123456789"
    )
...
def cliente(empresa):
    return Cliente.objects.create(
        id_empresa=empresa, razon_social="Cliente Test", nombre_comercial="ClienteCom", rif="V123456789"
    )

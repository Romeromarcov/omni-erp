"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``configuracion_motor``.
...
_TABLES = [
    ("configuracion_motor_parametro_sistema", "id_empresa_id", True),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("configuracion_motor", "0004_alter_catalogovalor_id_catalogo_valor_and_more"),
    ]

"""RLS lote 3 (CTF-012, P0-1 rollout) — tablas tenant de ``banca_electronica``.
...
_TABLES = [
    ("banca_electronica_cuentabancariaempresa", "empresa_id", False),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("banca_electronica", "0002_initial"),
    ]

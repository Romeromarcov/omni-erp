...
Complementa (sin duplicar):
  - tests_api/test_mcp_server_scope.py  → núcleo de _resolve_token/_require_scope.
  - tests_api/test_mcp_tools_bugfixes.py → omni_get_empresas / omni_get_saldo_cliente.
  - tests_api/test_cxc_ws2_mcp.py       → omni_get_cxc_aging / stock / ventas_resumen básicos.

...
| CTF-005  | Whitelist explícita de campos (`fields="__all__"`) | 2026-09-01 | equipo-backend     | CERRADO  |
...
| CTF-014  | Migrar `tests_api/` a estructura por capas `tests/` | 2026-09-30 | equipo-backend         | CERRADO  |

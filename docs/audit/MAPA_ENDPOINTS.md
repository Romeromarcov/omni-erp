...
| `^bandeja/$` | BandejaFacturacionViewSet | BandejaFacturacion | ✅ | ✅ | IsAuthenticated |
| `^bandeja/(?P<pk>[^/.]+)/$` | BandejaFacturacionViewSet | BandejaFacturacion | ✅ | ✅ | IsAuthenticated |
| `^bandeja/(?P<pk>[^/.]+)/confirmar/$` | BandejaFacturacionViewSet | BandejaFacturacion | ✅ | ✅ | IsAuthenticated |
| `^bandeja/(?P<pk>[^/.]+)/confirmar\.(?P<format>[a-z0-9]+)/?$` | BandejaFacturacionViewSet | BandejaFacturacion | ✅ | ✅ | IsAuthenticated |
| `^bandeja/(?P<pk>[^/.]+)/proponer/$` | BandejaFacturacionViewSet | BandejaFacturacion | ✅ | ✅ | IsAuthenticated |
| `^bandeja/(?P<pk>[^/.]+)/proponer\.(?P<format>[a-z0-9]+)/?$` | BandejaFacturacionViewSet | BandejaFacturacion | ✅ | ✅ | IsAuthenticated |
| `^bandeja/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | BandejaFacturacionViewSet | BandejaFacturacion | ✅ | ✅ | IsAuthenticated |
| `^bandeja\.(?P<format>[a-z0-9]+)/?$` | BandejaFacturacionViewSet | BandejaFacturacion | ✅ | ✅ | IsAuthenticated |
...
| `^conciliaciones/$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^conciliaciones/(?P<pk>[^/.]+)/$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^conciliaciones/(?P<pk>[^/.]+)/revisar/$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^conciliaciones/(?P<pk>[^/.]+)/revisar\.(?P<format>[a-z0-9]+)/?$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^conciliaciones/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^conciliaciones/conciliar/$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^conciliaciones/conciliar\.(?P<format>[a-z0-9]+)/?$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^conciliaciones/resumen/$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^conciliaciones/resumen\.(?P<format>[a-z0-9]+)/?$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^conciliaciones\.(?P<format>[a-z0-9]+)/?$` | ConciliacionLubrikcaViewSet | ConciliacionLubrikca | ✅ | ✅ | IsAuthenticated |
| `^config-conciliacion/$` | ConfiguracionConciliacionViewSet | ConfiguracionConciliacion | ✅ | ✅ | IsAuthenticated |
| `^config-conciliacion/(?P<pk>[^/.]+)/$` | ConfiguracionConciliacionViewSet | ConfiguracionConciliacion | ✅ | ✅ | IsAuthenticated |
| `^config-conciliacion/(?P<pk>[^/.]+)/activar/$` | ConfiguracionConciliacionViewSet | ConfiguracionConciliacion | ✅ | ✅ | IsAuthenticated |
| `^config-conciliacion/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | ConfiguracionConciliacionViewSet | ConfiguracionConciliacion | ✅ | ✅ | IsAuthenticated |
| `^config-conciliacion/(?P<pk>[^/.]+)/desactivar/$` | ConfiguracionConciliacionViewSet | ConfiguracionConciliacion | ✅ | ✅ | IsAuthenticated |
| `^config-conciliacion/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | ConfiguracionConciliacionViewSet | ConfiguracionConciliacion | ✅ | ✅ | IsAuthenticated |
| `^config-conciliacion/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | ConfiguracionConciliacionViewSet | ConfiguracionConciliacion | ✅ | ✅ | IsAuthenticated |
| `^config-conciliacion\.(?P<format>[a-z0-9]+)/?$` | ConfiguracionConciliacionViewSet | ConfiguracionConciliacion | ✅ | ✅ | IsAuthenticated |
...
| `^descuentos-bcv-completo/$` | DescuentoBCVCompletoViewSet | DescuentoBCVCompleto | ✅ | — | IsAuthenticated |
| `^descuentos-bcv-completo/(?P<pk>[^/.]+)/$` | DescuentoBCVCompletoViewSet | DescuentoBCVCompleto | ✅ | — | IsAuthenticated |
| `^descuentos-bcv-completo/(?P<pk>[^/.]+)/activar/$` | DescuentoBCVCompletoViewSet | DescuentoBCVCompleto | ✅ | — | IsAuthenticated |
| `^descuentos-bcv-completo/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | DescuentoBCVCompletoViewSet | DescuentoBCVCompleto | ✅ | — | IsAuthenticated |
| `^descuentos-bcv-completo/(?P<pk>[^/.]+)/desactivar/$` | DescuentoBCVCompletoViewSet | DescuentoBCVCompleto | ✅ | — | IsAuthenticated |
| `^descuentos-bcv-completo/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | DescuentoBCVCompletoViewSet | DescuentoBCVCompleto | ✅ | — | IsAuthenticated |
| `^descuentos-bcv-completo/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | DescuentoBCVCompletoViewSet | DescuentoBCVCompleto | ✅ | — | IsAuthenticated |
| `^descuentos-bcv-completo\.(?P<format>[a-z0-9]+)/?$` | DescuentoBCVCompletoViewSet | DescuentoBCVCompleto | ✅ | — | IsAuthenticated |
| `^descuentos-marca-categoria/$` | DescuentoMarcaCategoriaViewSet | DescuentoMarcaCategoria | ✅ | — | IsAuthenticated |
| `^descuentos-marca-categoria/(?P<pk>[^/.]+)/$` | DescuentoMarcaCategoriaViewSet | DescuentoMarcaCategoria | ✅ | — | IsAuthenticated |
| `^descuentos-marca-categoria/(?P<pk>[^/.]+)/activar/$` | DescuentoMarcaCategoriaViewSet | DescuentoMarcaCategoria | ✅ | — | IsAuthenticated |
| `^descuentos-marca-categoria/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | DescuentoMarcaCategoriaViewSet | DescuentoMarcaCategoria | ✅ | — | IsAuthenticated |
| `^descuentos-marca-categoria/(?P<pk>[^/.]+)/desactivar/$` | DescuentoMarcaCategoriaViewSet | DescuentoMarcaCategoria | ✅ | — | IsAuthenticated |
| `^descuentos-marca-categoria/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | DescuentoMarcaCategoriaViewSet | DescuentoMarcaCategoria | ✅ | — | IsAuthenticated |
| `^descuentos-marca-categoria/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | DescuentoMarcaCategoriaViewSet | DescuentoMarcaCategoria | ✅ | — | IsAuthenticated |
| `^descuentos-marca-categoria\.(?P<format>[a-z0-9]+)/?$` | DescuentoMarcaCategoriaViewSet | DescuentoMarcaCategoria | ✅ | — | IsAuthenticated |
| `^despachos/$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/cancelar/$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/cancelar\.(?P<format>[a-z0-9]+)/?$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/devolver/$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/devolver\.(?P<format>[a-z0-9]+)/?$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/entregar/$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/entregar\.(?P<format>[a-z0-9]+)/?$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/iniciar-ruta/$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/iniciar-ruta\.(?P<format>[a-z0-9]+)/?$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/pdf/$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)/pdf\.(?P<format>[a-z0-9]+)/?$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/desde-nota-venta/$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
| `^despachos/desde-nota-venta\.(?P<format>[a-z0-9]+)/?$` | DespachoViewSet | Despacho | ✅ | ✅ | IsAuthenticated |
...
| `^feriados/$` | FeriadoViewSet | Feriado | ✅ | — | IsAuthenticated |
| `^feriados/(?P<pk>[^/.]+)/$` | FeriadoViewSet | Feriado | ✅ | — | IsAuthenticated |
| `^feriados/(?P<pk>[^/.]+)/activar/$` | FeriadoViewSet | Feriado | ✅ | — | IsAuthenticated |
| `^feriados/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | FeriadoViewSet | Feriado | ✅ | — | IsAuthenticated |
| `^feriados/(?P<pk>[^/.]+)/desactivar/$` | FeriadoViewSet | Feriado | ✅ | — | IsAuthenticated |
| `^feriados/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | FeriadoViewSet | Feriado | ✅ | — | IsAuthenticated |
| `^feriados/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | FeriadoViewSet | Feriado | ✅ | — | IsAuthenticated |
| `^feriados\.(?P<format>[a-z0-9]+)/?$` | FeriadoViewSet | Feriado | ✅ | — | IsAuthenticated |
...
| `^lineas-pedido/$` | LineaPedidoLubrikcaViewSet | LineaPedidoLubrikca | ✅ | — | IsAuthenticated |
| `^lineas-pedido/(?P<pk>[^/.]+)/$` | LineaPedidoLubrikcaViewSet | LineaPedidoLubrikca | ✅ | — | IsAuthenticated |
| `^lineas-pedido/(?P<pk>[^/.]+)/activar/$` | LineaPedidoLubrikcaViewSet | LineaPedidoLubrikca | ✅ | — | IsAuthenticated |
| `^lineas-pedido/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | LineaPedidoLubrikcaViewSet | LineaPedidoLubrikca | ✅ | — | IsAuthenticated |
| `^lineas-pedido/(?P<pk>[^/.]+)/desactivar/$` | LineaPedidoLubrikcaViewSet | LineaPedidoLubrikca | ✅ | — | IsAuthenticated |
| `^lineas-pedido/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | LineaPedidoLubrikcaViewSet | LineaPedidoLubrikca | ✅ | — | IsAuthenticated |
| `^lineas-pedido/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | LineaPedidoLubrikcaViewSet | LineaPedidoLubrikca | ✅ | — | IsAuthenticated |
| `^lineas-pedido\.(?P<format>[a-z0-9]+)/?$` | LineaPedidoLubrikcaViewSet | LineaPedidoLubrikca | ✅ | — | IsAuthenticated |
...
| `^metodos-pago/(?P<pk>[^/.]+)/$` | MetodoPagoViewSet | MetodoPago | ✅ | — | IsAuthenticated |
| `^metodos-pago/(?P<pk>[^/.]+)/activar/$` | MetodoPagoViewSet | MetodoPago | ✅ | — | IsAuthenticated |
| `^metodos-pago/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | MetodoPagoViewSet | MetodoPago | ✅ | — | IsAuthenticated |
| `^metodos-pago/(?P<pk>[^/.]+)/desactivar/$` | MetodoPagoViewSet | MetodoPago | ✅ | — | IsAuthenticated |
| `^metodos-pago/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | MetodoPagoViewSet | MetodoPago | ✅ | — | IsAuthenticated |
| `^metodos-pago/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | MetodoPagoViewSet | MetodoPago | ✅ | — | IsAuthenticated |
...
| `^pagos/$` | PagoLubrikcaViewSet | PagoLubrikca | ✅ | — | IsAuthenticated |
| `^pagos/$` | PagoViewSet | Pago | ✅ | ✅ | IsAuthenticated |
| `^pagos/(?P<pk>[^/.]+)/$` | PagoLubrikcaViewSet | PagoLubrikca | ✅ | — | IsAuthenticated |
| `^pagos/(?P<pk>[^/.]+)/$` | PagoViewSet | Pago | ✅ | ✅ | IsAuthenticated |
| `^pagos/(?P<pk>[^/.]+)/activar/$` | PagoLubrikcaViewSet | PagoLubrikca | ✅ | — | IsAuthenticated |
| `^pagos/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | PagoLubrikcaViewSet | PagoLubrikca | ✅ | — | IsAuthenticated |
| `^pagos/(?P<pk>[^/.]+)/desactivar/$` | PagoLubrikcaViewSet | PagoLubrikca | ✅ | — | IsAuthenticated |
| `^pagos/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | PagoLubrikcaViewSet | PagoLubrikca | ✅ | — | IsAuthenticated |
| `^pagos/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | PagoLubrikcaViewSet | PagoLubrikca | ✅ | — | IsAuthenticated |
...
| `^pagos\.(?P<format>[a-z0-9]+)/?$` | PagoLubrikcaViewSet | PagoLubrikca | ✅ | — | IsAuthenticated |
...
| `^pedidos/$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos/$` | PedidoViewSet | Pedido | ✅ | ✅ | IsAuthenticated |
| `^pedidos/(?P<pk>[^/.]+)/$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos/(?P<pk>[^/.]+)/$` | PedidoViewSet | Pedido | ✅ | ✅ | IsAuthenticated |
| `^pedidos/(?P<pk>[^/.]+)/activar/$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
...
| `^pedidos/(?P<pk>[^/.]+)/desactivar/$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos/(?P<pk>[^/.]+)/recalcular/$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos/(?P<pk>[^/.]+)/recalcular\.(?P<format>[a-z0-9]+)/?$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | PedidoViewSet | Pedido | ✅ | ✅ | IsAuthenticated |
| `^pedidos/sincronizar/$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos/sincronizar\.(?P<format>[a-z0-9]+)/?$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
| `^pedidos\.(?P<format>[a-z0-9]+)/?$` | PedidoLubrikcaViewSet | PedidoLubrikca | ✅ | — | IsAuthenticated |
...
| `^precios-lista/$` | PrecioListaLubrikcaViewSet | PrecioListaLubrikca | ✅ | — | IsAuthenticated |
| `^precios-lista/(?P<pk>[^/.]+)/$` | PrecioListaLubrikcaViewSet | PrecioListaLubrikca | ✅ | — | IsAuthenticated |
| `^precios-lista/(?P<pk>[^/.]+)/activar/$` | PrecioListaLubrikcaViewSet | PrecioListaLubrikca | ✅ | — | IsAuthenticated |
| `^precios-lista/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | PrecioListaLubrikcaViewSet | PrecioListaLubrikca | ✅ | — | IsAuthenticated |
| `^precios-lista/(?P<pk>[^/.]+)/desactivar/$` | PrecioListaLubrikcaViewSet | PrecioListaLubrikca | ✅ | — | IsAuthenticated |
| `^precios-lista/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | PrecioListaLubrikcaViewSet | PrecioListaLubrikca | ✅ | — | IsAuthenticated |
| `^precios-lista/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | PrecioListaLubrikcaViewSet | PrecioListaLubrikca | ✅ | — | IsAuthenticated |
| `^precios-lista\.(?P<format>[a-z0-9]+)/?$` | PrecioListaLubrikcaViewSet | PrecioListaLubrikca | ✅ | — | IsAuthenticated |
...
| `^promociones-primera-compra/$` | PromocionPrimeraCompraViewSet | PromocionPrimeraCompra | ✅ | — | IsAuthenticated |
| `^promociones-primera-compra/(?P<pk>[^/.]+)/$` | PromocionPrimeraCompraViewSet | PromocionPrimeraCompra | ✅ | — | IsAuthenticated |
| `^promociones-primera-compra/(?P<pk>[^/.]+)/activar/$` | PromocionPrimeraCompraViewSet | PromocionPrimeraCompra | ✅ | — | IsAuthenticated |
| `^promociones-primera-compra/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | PromocionPrimeraCompraViewSet | PromocionPrimeraCompra | ✅ | — | IsAuthenticated |
| `^promociones-primera-compra/(?P<pk>[^/.]+)/desactivar/$` | PromocionPrimeraCompraViewSet | PromocionPrimeraCompra | ✅ | — | IsAuthenticated |
| `^promociones-primera-compra/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | PromocionPrimeraCompraViewSet | PromocionPrimeraCompra | ✅ | — | IsAuthenticated |
| `^promociones-primera-compra/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | PromocionPrimeraCompraViewSet | PromocionPrimeraCompra | ✅ | — | IsAuthenticated |
| `^promociones-primera-compra\.(?P<format>[a-z0-9]+)/?$` | PromocionPrimeraCompraViewSet | PromocionPrimeraCompra | ✅ | — | IsAuthenticated |
...
| `^reglas-recurrencia/$` | ReglaRecurrenciaViewSet | ReglaRecurrencia | ✅ | — | IsAuthenticated |
| `^reglas-recurrencia/(?P<pk>[^/.]+)/$` | ReglaRecurrenciaViewSet | ReglaRecurrencia | ✅ | — | IsAuthenticated |
| `^reglas-recurrencia/(?P<pk>[^/.]+)/activar/$` | ReglaRecurrenciaViewSet | ReglaRecurrencia | ✅ | — | IsAuthenticated |
| `^reglas-recurrencia/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | ReglaRecurrenciaViewSet | ReglaRecurrencia | ✅ | — | IsAuthenticated |
| `^reglas-recurrencia/(?P<pk>[^/.]+)/desactivar/$` | ReglaRecurrenciaViewSet | ReglaRecurrencia | ✅ | — | IsAuthenticated |
| `^reglas-recurrencia/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | ReglaRecurrenciaViewSet | ReglaRecurrencia | ✅ | — | IsAuthenticated |
| `^reglas-recurrencia/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | ReglaRecurrenciaViewSet | ReglaRecurrencia | ✅ | — | IsAuthenticated |
| `^reglas-recurrencia\.(?P<format>[a-z0-9]+)/?$` | ReglaRecurrenciaViewSet | ReglaRecurrencia | ✅ | — | IsAuthenticated |
...
| `^vinculaciones/$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
| `^vinculaciones/(?P<pk>[^/.]+)/$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
| `^vinculaciones/(?P<pk>[^/.]+)/activar/$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
| `^vinculaciones/(?P<pk>[^/.]+)/activar\.(?P<format>[a-z0-9]+)/?$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
| `^vinculaciones/(?P<pk>[^/.]+)/desactivar/$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
| `^vinculaciones/(?P<pk>[^/.]+)/desactivar\.(?P<format>[a-z0-9]+)/?$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
| `^vinculaciones/(?P<pk>[^/.]+)\.(?P<format>[a-z0-9]+)/?$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
| `^vinculaciones/registrar/$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
| `^vinculaciones/registrar\.(?P<format>[a-z0-9]+)/?$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
| `^vinculaciones\.(?P<format>[a-z0-9]+)/?$` | VinculacionViewSet | Vinculacion | ✅ | ✅ | IsAuthenticated |
